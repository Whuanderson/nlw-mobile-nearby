...
export default function Market() {
  ...
  const [permission, requestPermission] = useCameraPermissions(); // pode omitir o premission substituiond por "_" se não for utilizar ele. e for utilizar apenas o request permission
